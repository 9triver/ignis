...
var file_cluster_cluster_proto_goTypes = []any{
	...
	(*proto.StreamChunk)(nil),    // 9: proto.StreamChunk
	(proto.Language)(0),          // 10: proto.Language
	(*proto.Invoke)(nil),         // 11: proto.Invoke
	(*proto.InvokeStart)(nil),    // 12: proto.InvokeStart
	(*proto.InvokeResponse)(nil), // 13: proto.InvokeResponse
}
var file_cluster_cluster_proto_depIdxs = []int32{
	8,  // 0: cluster.ObjectResponse.Value:type_name -> proto.EncodedObject
	0,  // 1: cluster.Envelope.Type:type_name -> cluster.MessageType
	1,  // 2: cluster.Envelope.ObjectRequest:type_name -> cluster.ObjectRequest
	2,  // 3: cluster.Envelope.ObjectResponse:type_name -> cluster.ObjectResponse
	9,  // 4: cluster.Envelope.StreamChunk:type_name -> proto.StreamChunk
	10, // 5: cluster.Function.Language:type_name -> proto.Language
	0,  // 6: cluster.Message.Type:type_name -> cluster.MessageType
	4,  // 7: cluster.Message.Ack:type_name -> cluster.Ack
	5,  // 8: cluster.Message.Ready:type_name -> cluster.Ready
	11, // 9: cluster.Message.Invoke:type_name -> proto.Invoke
	12, // 10: cluster.Message.InvokeStart:type_name -> proto.InvokeStart
	13, // 11: cluster.Message.InvokeResponse:type_name -> proto.InvokeResponse
	1,  // 12: cluster.Message.ObjectRequest:type_name -> cluster.ObjectRequest
	2,  // 13: cluster.Message.ObjectResponse:type_name -> cluster.ObjectResponse
	9,  // 14: cluster.Message.StreamChunk:type_name -> proto.StreamChunk
	6,  // 15: cluster.Message.Function:type_name -> cluster.Function
	7,  // 16: cluster.Service.Session:input_type -> cluster.Message
	7,  // 17: cluster.Service.Session:output_type -> cluster.Message
